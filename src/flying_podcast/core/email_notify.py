...
def _build_report_html(
    ...
    # --- Compose stage ---
    dom_count = compose_meta.get("domestic_count", "?")
    intl_count = compose_meta.get("international_count", "?")
...
<div class="wrap">
  ...
  <div class="stage">
    ...
    <span class="metric">国内 <b>{dom_count}</b></span>
    <span class="metric">国际 <b>{intl_count}</b></span>
  ...
  <div class="footer">此邮件由飞行播客系统自动发送</div>
</div>
</body></html>"""
...
def send_pipeline_report(
    ...
    sender_name = settings.email_sender or "飞行播客"
